                ...
                <div class="row">
                    ...
                    <div class="menu-wrapper col-md-9 col-sm-6 col-xs-4">
                        ...
                        echo"<ul class='sf-menu hidden-xs hidden-sm'>
                            ...
                            <li class='active'><a href='BOOKRETURN.php?dep=$dep'>Book return</a></li>
            ...
            <div class="inner-container container">
                <div class="row">
                    <div class="section-header col-md-12">
                        <h2>Enter the Book ID</H2><br>
                        <SPAN>Enter the book id and click "Search" to get the Book Name and student details.</SPAN><br>
                        <span>Once the details has been verified click "Return" to return the book from the library</SPAN>
                    </div> 
                </div> 
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="contact-form-inner"><?php
                                    $dep=$_GET["dep"];
                                    echo"<form method='post' action='searchbook.php?dep=$dep' name='contactform' id='contactform'>
                                        <p>
                                            <br>
                                            <br>
                                            <br>
    ...
    $conn = new mysqli($host, $user, $password, $dbname, $port, $socket)
        ...
        // output data of each row
            while($row = $result->fetch_assoc()) {
                ...
                $flag=1;
                echo "
                <h2>_________BOOK NAME_________</h2><P> $id</P><BR>
                <h2>_________STUDENT NAME_________</h2><P> $NAME</P><BR>
                <h2>_________STUDENT ROLL NUMBER_________</h2><P> $NO</P><BR>
                <h2>_________ISSUE DATE_________</h2><P> $IDATE</P><br>
                <h2>_________DUE DATE_________</h2><P> $DDATE</P>
                <form name='contactform' id='contactform'>
                <a href='return.php?var1=$id&dep=$dep'><input type='button' class='mainBtn' id='submit' value='Return' /></a>
                 </form>";
                }
            }
        } 
        if ($flag==0){
            ...
            window.location.replace('BOOKRETURN.php?dep=$dep')</script>";
        }
    ?>
                                </div>
