                ...
                <div class="row">
                    ...
                    <div class="menu-wrapper col-md-9 col-sm-6 col-xs-4">
                        ...
                        echo"<ul class='sf-menu hidden-xs hidden-sm'>
                            ...
                            <li class='active'><a href='#'>Book return</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="googlemap-wrapper">
                                        ...
                                        <h2>_________STUDENT NAME_________</h2><P> WILL BE DISPLAYED HERE:</P><BR>
                                        <h2>_________STUDENT ROLL NUMBER_________</h2><P> WILL BE DISPLAYED HERE:</P><BR>
                                        <h2>_________ISSUE DATE_________</h2><P> WILL BE DISPLAYED HERE:</P><br>
                                        <h2>_________DUE DATE_________</h2><P> WILL BE DISPLAYED HERE:</P>
                                </div>
