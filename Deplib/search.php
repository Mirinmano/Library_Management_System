                ...
                <div class="row">
                    ...
                    <div class="menu-wrapper col-md-9 col-sm-6 col-xs-4">
                        ...
                        echo"<ul class='sf-menu hidden-xs hidden-sm'>
                            ...
                            <li class='active'><a href='bookissue.php?dep=$dep'>Book issue</a></li>
    ...
    $conn = new mysqli($host, $user, $password, $dbname, $port, $socket)
        ...
        // output data of each row
            while($row = $result->fetch_assoc()) {
                ...
                $flag=1;
                echo "
                <h2>_________BOOK ID_________</h2><P>$id</P><BR>
                <h2>_________BOOK NAME_________</h2><P>$BNAME</P><BR>
                <h2>_________AUTHOR'S NAME_________</h2><P>$ANAME</P><BR>
                <h2>_________YEAR OF PUBLICATION_________</h2><P>$YEAR</P><BR>
                <h2>_________PRICE_________</h2><P>$PRICE</P>
                <form name='contactform' id='contactform'>
                <a href='remove.php?variable1=$id&dep=$dep'><input type='button' class='mainBtn' id='submit' value='Remove' /></a>
                 </form>";
                }
            }
        } 
        if ($flag==0){
            ...
            window.location.replace('remove book.php?dep=$dep')</script>";
        }
    ?>
                                </div>
