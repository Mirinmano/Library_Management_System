                ...
                <div class="row">
                    ...
                    <div class="menu-wrapper col-md-9 col-sm-6 col-xs-4">
                        ...
                        echo"<ul class='sf-menu hidden-xs hidden-sm'>
                            ...
                            <li class='active'><a href='#'>Book issue</a></li>
            ...
            <div class="inner-container container">
                <div class="row">
                    <div class="section-header col-md-12">
                        <h2>Enter the Book & Student details:</h2><br>
                        <SPAN>Enter the book id and click "Search" to get the book details.</SPAN>
                        <span>Once the book details has been verified, Enter the student details.</SPAN><br>
                        <span>Then click "ISSUE" to issue the book to the respective student.</span>
                    </div> 
                </div> 
                <div class="contact-form">
                    <div class="box-content col-md-12">
                        <div class="row">
                            <div class="col-md-7">
                                <div class="contact-form-inner"><center><?php
                                    $dep=$_GET["dep"];
                                    echo"<form method='post' action='transaction.php?dep=$dep' name='contactform' id='contactform'>
                                        ...
                                        <p>
                                            ...
                                            <input name='stname' type='text' id='name'>
                                        </p><BR>
                                        <p>
                                            <label for='stno'>ID :</label>
                                            <input name='stno' type='text' id='name'>
                                        </p><BR>
                                       <input type='submit' class='mainBtn' id='submit' value='ISSUE' />
                                    <br><br><br>
                                    </form>";
                                    ?></center>
                                </div>
